...
const About = () => {
  ...
  return (
    <div className="bg-transparent text-white min-h-screen">
      <title>
        About Us | Sky Smart Intelligence - Leading IoT & AI Solutions
      </title>
      <meta
        name="description"
        content="Learn about Sky Smart Intelligence, our mission to bridge physical and digital worlds, and our expert team driving industrial IoT innovation."
      />
      <link
        rel="canonical"
        href="https://skyaccount.perahara.lk/company/about"
      />
      {/* Page Cover */}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center lg:pl-16">
            ...
            >
              ...
              <p className="text-gray-400 text-lg font-light leading-relaxed mb-10 max-w-xl">
                Founded in 2006, Sky Smart Technology has emerged as a
                powerhouse in industrial automation and IoT research. We don't
                just build sensors; we build the nervous system of modern
                industry. Our mission is to transform raw factory floor data
                into actionable intelligence, scaling across South Asia and
                beyond.
              </p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              className="w-12 h-1 bg-cyan-400 mb-6 mx-auto"
            />
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              We design and deploy industrial-focused IoT ecosystems built for
              reliability and real-time performance: hardened edge devices,
              secure cloud connectivity, and production-oriented analytics. Our
              approach pairs efficient, low-latency telemetry with disciplined
              data governance so customers gain actionable insights, maintain
              operational security, and realize predictable returns on
              investment.
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-transparent relative z-10">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              Since 2015 we’ve evolved from early electronics and prototype IoT
              solutions into a trusted partner for industrial automation and
              real-time monitoring. From initial field pilots and first
              commercial deployments through regional expansions, each milestone
              reflects measurable improvements in operational efficiency for our
              partners and frames how we scale practical automation and software
              projects.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <motion.div
              ...
              className="w-12 h-1 bg-cyan-400 mb-6 mx-auto"
            />
            <span className="text-cyan-400 font-bold tracking-[0.4em] text-[10px] uppercase block mb-3">
              Impact
            </span>
            <h4 className="text-3xl md:text-3xl font-black mb-3">
              Awards & Sustainability
            </h4>
            <p className="text-gray-400 max-w-3xl mx-auto">
              At Sky Smart Technology, our engineering choices emphasize
              efficiency and longevity — deploying energy-smart sensors, modular
              designs that extend device life, and secure software practices.
              These decisions help reduce operational waste and total cost of
              ownership for customers while enabling industrial operators to
              pursue stronger sustainability outcomes through better data
              visibility and optimized processes.
            </p>
          </motion.div>
        </div>
      </section>
