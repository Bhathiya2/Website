...
const Projects = () => {
  ...
  return (
    <div className="bg-transparent min-h-screen text-white">
      <title>
        Projects & Case Studies | Sky Smart Intelligence - Industrial IoT
        Portfolio
      </title>
      <meta
        name="description"
        content="Explore our portfolio of successful industrial IoT and automation projects, from energy optimization to smart agriculture and maritime logistics."
      />
      <link
        rel="canonical"
        href="https://skyaccount.perahara.lk/company/projects"
      />
      {/* Page Cover */}
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">
                Proven{" "}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500 italic pr-3">
                  Integrations
                </span>
              </h2>
            </div>
            <p className="text-zinc-500 text-sm max-w-sm font-medium uppercase tracking-widest leading-relaxed">
              Exploring the frontiers of industrial efficiency across diverse
              global sectors.
            </p>
          </div>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="bg-black/50 border border-white/5 rounded-[2rem] overflow-hidden animate-pulse"
                >
            ...
            <p className="text-zinc-500 text-center py-20 uppercase tracking-widest text-sm">
              No projects found.
            </p>
          ) : (
            <motion.div
                  ...
                  >
                    ...
                    <div className="p-8">
                      <div className="flex items-center gap-2 mb-4">
                        <span className="text-[10px] font-black text-cyan-400 tracking-widest uppercase bg-cyan-500/10 px-2 py-0.5 rounded">
                          Active
                        </span>
