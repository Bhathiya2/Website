...
const timeline = [
  {
    year: "2008",
    title: "Foundation",
    text: "Sky Smart Technology was established with a focus on software and electronics solutions.",
    icon: Flag,
  },
  {
    year: "2015",
    title: "First Projects",
    text: "Delivered initial web and electronic system projects for local clients.",
    icon: Rocket,
  },
  {
    year: "2020",
    title: "IoT Expansion",
    text: "Expanded into IoT and embedded system development.",
    icon: Globe,
  },
  {
    year: "2023",
    title: "Product Growth",
    text: "Developed custom platforms, dashboards, and mobile applications.",
    icon: Zap,
  },
  {
    year: "Future",
    title: "Looking Ahead",
    text: "Continuously innovating in software, electronics, and smart systems.",
    icon: CalendarCheck,
  },
];
...
export default function TimelineSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="py-24 md:py-32 bg-transparent relative overflow-hidden text-white z-10 px-4 md:px-0"
    >
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-4">
            ...
            <span className="text-cyan-400 font-black tracking-[0.3em] text-[10px] uppercase">
              Timeline Protocol
            </span>
          </div>
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-none tracking-tighter">
            OUR{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500 italic pr-5">
              JOURNEY
            </span>
          </h2>
        </motion.div>
...
function TimelineItem({ item, index }) {
  ...
  return (
    <div
      className={`relative flex items-center w-full ${isEven ? "md:flex-row" : "md:flex-row-reverse"} justify-start md:justify-between group`}
    >
      {/* Center Node */}
      ...
      >
        <div className="relative group/card">
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-white/5 p-6 md:p-8 rounded-xl hover:border-cyan-400/40 transition-all duration-500 relative overflow-hidden group-hover/card:shadow-[0_0_30px_rgba(34,211,238,0.1)]">
            ...
            <div
              className={`relative z-10 block md:flex gap-6 items-center ${isEven ? "flex-row-reverse" : "flex-row"}`}
            >
              {/* Year Badge */}
