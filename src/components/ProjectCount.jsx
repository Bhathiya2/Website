...
import { Users, FolderKanban, UserRoundCheck, Clock } from "lucide-react";
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed border-t border-white/5 pt-6 font-medium group-hover:text-zinc-300 transition-colors">
                  {stat.description}
                </p>
              </div>
