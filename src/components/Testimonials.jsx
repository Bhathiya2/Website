        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-24 gap-12">
          ...
          >
            <div className="pr-4 border-r border-white/10">
              ...
              <div className="text-white font-black text-xs leading-none tracking-tighter">
                5.0 SCORE
              </div>
            </div>
            <div>
              <div className="text-cyan-400 font-mono text-[9px] font-black leading-none">
                ACTIVE_NODES
              </div>
              ...
              >
                ...
                <div className="mb-6 flex justify-between items-center">
                  <div className="flex items-center gap-2 bg-transparent/5 border border-white/10 px-3 py-1.5 rounded-lg">
                    ...
                    <span className="text-cyan-400 text-[9px] uppercase font-mono font-black tracking-widest">
                      {t.stat}
                    </span>
                  </div>
                ...
                <div className="mt-8 flex items-center gap-4 pt-6 border-t border-white/5">
                  ...
                  <div>
                    <h4 className="text-white font-bold text-sm mb-0.5 uppercase tracking-tight">
                      {t.name}
                    </h4>
                    <p className="text-cyan-400/60 text-[9px] font-black tracking-widest uppercase">
                      {t.role} // {t.company}
                    </p>
                  </div>
                </div>
